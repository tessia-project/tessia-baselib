...
class Config(object):
    ...
    DEFAULT_CFG = '/etc/tessia/tessia-baselib.yaml'
    ...
    def _parse_config(cls):
        ...
        defined by env variable TESSIA_BASELIB_CFG if set, otherwise falls
        back to default.
        ...
        cls._config_file = os.environ.get('TESSIA_BASELIB_CFG')
